...
export default function AttendanceWorkTime() {
  ...
  return (
    <>
      <SecondsConvertToTimeNavbar seconds={workingTimeSecond}  blinkCondition={attendance_last_activity === 'check_in' || attendance_last_activity === 'break_end' ? true : false} />
    </>
  );
}
