...
export default function AttendanceBreakTime() {
  ...
  const calculateTimeDifference = (currentDate, checkinDate) => {
    ...
    return (
      <>
        <SecondsConvertToTimeNavbar seconds={breakTimeSecond}  blinkCondition={attendance_last_activity === 'break_start' ? true : false} />
      </>
    );
}
