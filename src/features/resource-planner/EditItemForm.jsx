...
`;
  ...
  //     );
  //     console.log(" user.assignmentsRecords", user.assignmentsRecords);
  ...
  const [start, setStart] = useState(formData.start);

  const [end, setEnd] = useState(formData.end);
  ...
  const handleSubmit = async (e) => {
    ...
    const updatedData = {
      ...
      // from_date: formData.start || start,
      // to_date: formData.end || end,
      from_date: start,
      to_date: end,
    ...
    try {
      ...
      // await fetchData();
      console.log("Sending to updateResourcePlannerDataApi:", updatedData);

      fetchHandler();
      enqueueSnackbar("Resource updated successfully", {
        variant: "success",
      });
      // console.log("response in updatedData ", updatedData);
  ...
  return (
    <div className=" edit-item-form flex items-center justify-center">
                ...
                <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="flex flex-col gap-[10px]">
                    <CustomDateInput
                      ...
                      placeholder="YYYY/MM/DD"
                      inputClass="w-full h-10 !bg-white"
                      value={end || moment(formData.end).format("YYYY-MM-DD")}
                      onChange={handleChange}
                    />
                  </div>
                </div>
