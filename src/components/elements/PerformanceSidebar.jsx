        ...
        },
        {
                ...
                submenu_items: [
                  ...
                  },
                  {
                    ...
                    icon: "overview-new",
                    src:config.PUBLIC_URL + "/assets/images/amdital/performance/department.svg",
                    classActive:  ` bg-[#806BFF] text-[#FFFFFF]  `,
                    classInactive: ` hover:bg-[#806BFF] text-[#FFFFFF]  `,
                    show:true
                  },
                  {
                    ...
                    path: `/performance/individual-goal`,
                    icon: "overview-new",
                    src:config.PUBLIC_URL + "/assets/images/amdital/performance/individual.svg",
                    classActive:  ` bg-[#806BFF] text-[#FFFFFF]  `,
                    classInactive: ` hover:bg-[#806BFF] text-[#FFFFFF]  `,
                    show:true
                  },
                  {
                    title: "OKR Score",
                    path: `/performance/okr-score`,
                    icon: "overview-new",
                    src:config.PUBLIC_URL + "/assets/images/amdital/performance/okr.svg",
                    classActive:  ` bg-[#806BFF] text-[#FFFFFF]  `,
                    classInactive: ` hover:bg-[#806BFF] text-[#FFFFFF]  `,
                    show:true
                  },
                  {
                    ...
                    icon: "overview-new",
                    src:config.PUBLIC_URL + "/assets/images/amdital/performance/meeting.svg",
                    classActive:  ` bg-[#806BFF] text-[#FFFFFF]  `,
                    classInactive: ` hover:bg-[#806BFF] text-[#FFFFFF]  `,
                    show:true
                  },
                 ...
                 return item.owner && (
                  ...
                  >
                    ...
                    >
                      ...
                      {<div className={` absolute custom-shadow  hidden group-hover:block ${ item?.title === "Resource Planner" ? ` -right-[125px] ` : `-right-[84px] `}  z-[1000] `}>
            ...
            <div className={` min-h-screen w-full   bg-gradient-to-b from-[rgba(31,14,58,0.9)] to-[rgba(38,11,106,0.9)]   min-[1024px]:${showPopupMenu ? " min-[1024px]:hidden  " : " block "}   `}>
              <div className="  text-sm leading-4 font-medium ">
                <ul className="flex flex-col gap-2 py-4 ">
                  {sidebar_details?.menu_items[8]?.submenu_items?.map(
                    (sub_item,i) => (
