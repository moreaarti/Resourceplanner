...
const LmsSidebar = (props) => {

  const showPopupMenu = useSelector((state) => state?.general?.showPopupMenu);

  const [activeBackgroundColor,setActiveBackgroundColor] = useState(undefined)
  ...
  useEffect(() => {
   if( location.pathname === "/learning-management-system"){
    setActiveBackgroundColor("All Courses");
   }
   else{
          ...
          path: `/learning-management-system/`,
           wrapperclass: "hidden",
               submenu_items: [
                ...
                //  {
                //    title: "UI/UX Design",
                //    path: `/learning-management-system/ui-ux-design`,
                //    src:config.PUBLIC_URL + "/assets/images/amdital/lms/lms_ui_ux.svg",
                //    classActive:  ` bg-[#806BFF] text-[#FFFFFF]  `,
                //    classInactive: ` hover:bg-[#806BFF] text-[#FFFFFF]  `,
                //    show:true,
                //  },
                ...
                //   path: `/learning-management-system/graphic-design`,
                //   src:config.PUBLIC_URL + "/assets/images/amdital/lms/lms_graphic.svg",
                //   classActive:  ` bg-[#806BFF] text-[#FFFFFF]  `,
                //   classInactive: ` hover:bg-[#806BFF] text-[#FFFFFF]  `,
                //   show:true
                // },
                // {
                //   title: "Full Stack",
                //   path: `/learning-management-system/full-stack`,
                //   src:config.PUBLIC_URL + "/assets/images/amdital/lms/lms_full_stack.svg",
                //   classActive:  ` bg-[#806BFF] text-[#FFFFFF]  `,
                //   classInactive: ` hover:bg-[#806BFF] text-[#FFFFFF]  `,
                //   show:true
                // },
                ...
                //   path: `/learning-management-system/digital-marketing`,
                //   src:config.PUBLIC_URL + "/assets/images/amdital/lms/lms_digital_marketing.svg",
                //   classActive:  ` bg-[#806BFF] text-[#FFFFFF]  `,
                //   classInactive: ` hover:bg-[#806BFF] text-[#FFFFFF]  `,
                //   show:true
                // },
                ...
                //   path: `/learning-management-system/business-growth`,
                //   src:config.PUBLIC_URL + "/assets/images/amdital/lms/lms_business_growth.svg",
                //   classActive:  ` bg-[#806BFF] text-[#FFFFFF]  `,
                //   classInactive: ` hover:bg-[#806BFF] text-[#FFFFFF]  `,
                //   show:true
                // },
  ...
  return (
    <>
      ...
      >
        ...
        { 
          <div className=" flex  ">
            <div className="min-h-screen min-w-[50px] max-w-[50px] flex-col py-4 sidebar_color ">
            ...
            <div className={` min-h-screen   bg-gradient-to-b from-[rgba(31,14,58,0.9)] to-[rgba(38,11,106,0.9)]   min-[1024px]:${showPopupMenu ? " min-[1024px]:hidden  " : " block "}  w-full `}>
              <div className="  text-sm leading-4 font-medium ">
                <ul className="flex flex-col gap-2 py-4 ">
                  {sidebar_details?.menu_items[13]?.submenu_items?.map(
                    (sub_item,i) => (
